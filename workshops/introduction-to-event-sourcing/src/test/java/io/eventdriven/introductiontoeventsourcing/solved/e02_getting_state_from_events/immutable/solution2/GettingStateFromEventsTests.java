...
import static io.eventdriven.introductiontoeventsourcing.solved.e02_getting_state_from_events.immutable.solution2.FunctionalTools.FoldLeft.foldLeft;
import static io.eventdriven.introductiontoeventsourcing.solved.e02_getting_state_from_events.immutable.solution2.FunctionalTools.groupingByOrdered;
import static io.eventdriven.introductiontoeventsourcing.solved.e02_getting_state_from_events.immutable.solution2.GettingStateFromEventsTests.ShoppingCartEvent.*;
    ...
    public ProductItems remove(PricedProductItem productItem) {
      return new ProductItems(
        Arrays.stream(values())
          .map(pi -> pi.productId() == productItem.productId() ?
            new PricedProductItem(
              pi.productId(),
