...
import static io.eventdriven.introductiontoeventsourcing.e07_application_logic.esdb.mixed.app.shoppingcarts.ShoppingCartEvent.*;
...
public class ShoppingCartService {
  ...
  public static ProductItemAddedToShoppingCart handle(
    ...
    io.eventdriven.introductiontoeventsourcing.e07_application_logic.esdb.mixed.app.shoppingcarts.ShoppingCart shoppingCart
  ) {
  ...
  public static ShoppingCartConfirmed handle(ConfirmShoppingCart command, io.eventdriven.introductiontoeventsourcing.e07_application_logic.esdb.mixed.app.shoppingcarts.ShoppingCart shoppingCart) {
    if (shoppingCart.isClosed())
