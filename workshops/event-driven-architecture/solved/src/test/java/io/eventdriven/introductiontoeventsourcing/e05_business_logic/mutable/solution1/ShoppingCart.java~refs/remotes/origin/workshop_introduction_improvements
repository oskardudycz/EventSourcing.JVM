package io.eventdriven.introductiontoeventsourcing.e05_business_logic.mutable.solution1;

import io.eventdriven.introductiontoeventsourcing.e05_business_logic.mutable.solution1.ProductItems.ProductPriceCalculator;
...
import static io.eventdriven.introductiontoeventsourcing.e05_business_logic.mutable.solution1.ProductItems.ProductItems.PricedProductItem;
import static io.eventdriven.introductiontoeventsourcing.e05_business_logic.mutable.solution1.ProductItems.ProductItems.ProductItem;
import static io.eventdriven.introductiontoeventsourcing.e05_business_logic.mutable.solution1.ShoppingCartEvent.*;
