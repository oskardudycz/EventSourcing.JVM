package io.eventdriven.eventdrivenarchitecture.e07_application_logic.mongodb.immutable.app;
...
import io.eventdriven.eventdrivenarchitecture.e07_application_logic.mongodb.immutable.app.shoppingcarts.productItems.FakeProductPriceCalculator;
...
class Config {
  ...
  MongoDBEventStore eventStore(MongoClient mongoClient) {
    return MongoDBEventStore.with(Storage.EventAsDocument, mongoClient, "e07_application_logic_mongodb_immutable");
  }
