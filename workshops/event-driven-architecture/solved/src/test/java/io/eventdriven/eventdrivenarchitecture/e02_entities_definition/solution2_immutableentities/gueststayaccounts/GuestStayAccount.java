...
public record GuestStayAccount(
  ...
  public GuestStayAccountEvent checkout(@Nullable UUID groupCheckoutId, OffsetDateTime now) {
  ...
  public GuestStayAccount evolve(GuestStayAccount state, GuestStayAccountEvent event) {
    return switch (event) {
